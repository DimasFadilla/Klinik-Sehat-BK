...
<body id="page-top" onload="initClock()">
    ...
    <!-- <header class="masthead" style="background-color: #001f3f; color: white; text-align: center;"> -->
        <div class="container d-flex align-items-center flex-column">
            <!-- Masthead Avatar Image-->
            <img class="masthead-avatar mb-5" src="img/logo.png" alt="..." />
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">SELAMAT DATANG DI WEBSITE</h1>
